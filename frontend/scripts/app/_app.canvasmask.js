...
((body => {
    ...
    */
    ...
    app.canvasmask = {
        ...
        mask: function(image, mask_src, data)
        {
            (function(image){
                ...
                if (!is_undefined(image) && !is_undefined(image.src))
                {
                    ...
                    var width, height, crop_width, crop_height, thumb_w = 0, thumb_h = 0, ratio = 0;
                    ...
                    img.onload = function() {
                        ...
                        if (!is_undefined($(image).data('crop-width')) && !is_undefined($(image).data('crop-height')))
                        {
                        ...
                        mask.onload = function() {
                            ...
                            var sourceX = Math.ceil(thumb_w/2 - crop_width/2),
                                sourceY  =  Math.ceil(thumb_h/2 - crop_height/2);

                            var destX = imagecanvas.width / 2 - crop_width / 2;
                            var destY = imagecanvas.height / 2 - crop_height / 2;
                            ...
                            imagecontext.globalCompositeOperation = "source-in";
                            imagecontext.drawImage(img, destX, destY, crop_width, crop_height);
