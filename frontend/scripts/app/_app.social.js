    ...
    app.social = {
        ...
        command(command, data) {
            if (command == "NEW") {
                ...
                $('#user-registry input[name="firstname"]').val(
                    data.profile.first_name
                );
                $('#user-registry input[name="lastname"]').val(
                    data.profile.last_name
                );
                $('#user-registry input[name="external_provider"]').val(
                    data.social_provider
                );
                $('#user-registry input[name="external_identity"]').val(
                    data.profile.id
                );
            }
