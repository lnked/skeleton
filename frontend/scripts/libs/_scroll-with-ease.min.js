!(function() {
    $.fn.scrollWithEase = function(e) {
        !(function() {
            ...
            function a() {
                if (document.body) {
                    let e = document.body,
                        ...
                        r = e.scrollHeight;
                    if (
                        ((H = document.compatMode.indexOf("CSS") >= 0 ? a : e),
                        (g = e),
                        t(),
                        (D = !0),
                        top != self)
                        ...
                        r > o &&
                        (e.offsetHeight <= o || a.offsetHeight <= o)
                    ) {
                        let n = !1,
                            i = function() {
                                n ||
            ...
            function o(e, t, a, o) {
                if ((o || (o = 1e3), f(t, a), y.accelerationMax != 1)) {
                    let r = +new Date(),
                        n = r - C;
                    if (n < y.accelerationDelta) {
                        let i = (1 + 30 / n) / 2;
                        i > 1 &&
                            ((i = Math.min(i, y.accelerationMax)),
                            (t *= i),
                            (a *= i));
                    }
                    C = +new Date();
            ...
            function r(e) {
                ...
                if (
                    ...
                    e.defaultPrevented ||
                    d(g, "embed") ||
                    (d(t, "embed") && /\.pdf/i.test(t.src))
                )
                    return !0;
                let n = e.wheelDeltaX || 0,
                    i = e.wheelDeltaY || 0;
                return (
                    n || i || (i = e.wheelDelta || 0),
                    !(y.touchpadSupport || !p(i)) ||
                        (Math.abs(n) > 1.2 && (n *= y.stepSize / 120),
            ...
            function n(e) {
                let t = e.target,
                    a =
                        ...
                        e.altKey ||
                        e.metaKey ||
                        (e.shiftKey && e.keyCode !== T.spacebar);
                if (
                ...
                let r,
                    ...
                    l = c(g),
                    u = l.clientHeight;
                switch ((l == document.body && (u = window.innerHeight),
                e.keyCode)) {
                    case T.up:
                        i = -y.arrowScroll;
                        break;
            ...
            function l(e, t) {
                for (let a = e.length; a--; ) N[B(e[a])] = t;
                return t;
            }
            function c(e) {
                let overflow;
                ...
                do {
                    ...
                    if ((t.push(e), a === e.scrollHeight)) {
                        if (!k || H.clientHeight + 10 < a)
                            return l(t, document.body);
                    } else if (
            ...
            function w(e) {
                return e >= 1
                    ...
                    : e <= 0
                      ? 0
                      : (y.pulseNormalize == 1 && (y.pulseNormalize /= h(1)),
                        h(e));
            }
            var g,
                v = $.extend(
